...
function Main({featuredProduct}) {
  return (
    ...
    <section className='w-full max-w-[1960px] px-4 md:px-10 lg:px-20 mx-auto h-full flex flex-col justify-center items-center pt-20 md:pt-[120px]'>

      <div className='w-full justify-center items-center mb-20 md:mb-[120px]'>
        <h2 className='text-lg md:text-[24px] text-center font-medium md:font-semibold max-w-[616px] mx-auto leading-[28px] md:leading-[38.4px]'>
          {topText}
        </h2>
      </div>

      <div className="flex flex-col space-y-5 lg:space-y-0 lg:space-x-5 xl:space-x-0 lg:flex-row md:items-center justify-between w-full max-w-[1140px] base:max-w-[calc(89.0625%)] mr-auto">
